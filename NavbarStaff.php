...
<div class="container-nav">
  <a href="mainStaff.php" target="contents"><img class="logo" src="assets/images/icon.png" width="50" alt=""></a>
	<a href="mainStaff.php" target="contents"><img class="logo2" src="assets/images/icon2.png" width="150" alt=""></a>
  <nav>
    <ul>
      <li><a href="mainStaff.php" target="contents">Menu</a></li>
