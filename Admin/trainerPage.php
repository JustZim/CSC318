...
?>
	...
	<div class="bg-image"><br><br>
		...
		<center>
			<table id="trainer" class="myTable">
				<tr>
				...
				<?php
					...
					if(mysqli_num_rows($result) > 0) 
					{
						foreach($result as $row) { 
							...
							echo "<td>$tPackage</td>";
							echo "<td>$tDetail</td>";
							echo "<td><input type='button' onclick='location.href=\"trainerEdit.php?id=$tID\"' value='Edit'>";
							echo "<input type='button' onclick='delFunction(\"$tID\")' value='Delete'></td>";
...
<script>
  ...
  table = document.getElementById("trainer");
